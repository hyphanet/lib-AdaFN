with Agpl.Containers.NTrees;
with Agpl.Text_Io; use Agpl.Text_Io;
with Agpl.Trace; use Agpl.Trace;

with Ada.Finalization; use Ada.Finalization;

procedure T022_Trees is
   type Sides is (L, C, R);
   ...
   package Side_Trees is new Agpl.Containers.NTrees (Int, Sides);
   use Side_Trees;
...
begin
   declare
      ...
      procedure Print is new Side_Trees.Print (Image);
   begin
      T.Root.Insert (+1);
