...
--         25 November 2004 to change the formal parameter Sample  --
--                          in generic Write_PNG_Type_x procedures --
--                          to discrete (<>) rather than integer   --
--                          so that modular types can be matched.  --
--          1 December 2004 added third "&" function for chunks to --
--                          return a Chunk_List from two Chunks.   --
--                          Defined constants for gamma 1 and 2.2. --
--          3    March 2005 added fourth "&" function to join two  --
--                          Chunk_Lists.                           --
--         13   August 2006 changed Image_Handle to unconstrained. --
--                          Added with clause for Zlib to permit   --
--                          compression level to be controlled in  --
--                          calls to the Write_PNG_Type_x procs.   --
---------------------------------------------------------------------
---------------------------------------------------------------------
...
package PNG_IO is
  ...
  function Version return String; -- The package version, e.g. "4.2".
...
--   pragma Linker_Options ("-lz");
  ...
  -- The type Stream_Element is defined in Ada.Streams as "mod implementation defined".
  -- The most likely implementation is a byte, i.e. mod 2**8, on all modern systems,
  -- but it is not guaranteed that this will be so. If Stream_Element is not a byte,
  -- PNG_IO will not compile and work without modification (neither will Zlib_Ada).
